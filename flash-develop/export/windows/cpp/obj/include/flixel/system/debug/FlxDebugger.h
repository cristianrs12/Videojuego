...
HX_DECLARE_CLASS3(flixel,_system,debug,Stats)
...
class HXCPP_CLASS_ATTRIBUTES  FlxDebugger_obj : public ::openfl::_legacy::display::Sprite_obj{
	...
	public:
		...
		::flixel::_system::debug::Stats stats;
		::flixel::_system::debug::Log log;
		::flixel::_system::debug::Watch watch;
		::flixel::_system::debug::BitmapLog bitmapLog;
		::flixel::_system::debug::VCR vcr;
		::flixel::_system::debug::Console console;
		bool hasMouse;
		::flixel::_system::debug::DebuggerLayout _layout;
		...
		virtual ::flixel::_system::ui::FlxSystemButton addButton( ::flixel::_system::debug::ButtonAlignment Position,::openfl::_legacy::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  ToggleMode,hx::Null< bool >  UpdateLayout);
		...
		virtual Void removeButtonFromArray( Array< ::Dynamic > Arr,::flixel::_system::ui::FlxSystemButton Button);
