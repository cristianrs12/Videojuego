...
HX_DECLARE_CLASS3(flixel,_system,debug,StatsGraph)
...
class HXCPP_CLASS_ATTRIBUTES  Stats_obj : public ::flixel::_system::debug::Window_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.system.debug.Stats")
		...
		int _totalCount;
		int _currentTime;
		::flixel::_system::debug::StatsGraph fpsGraph;
		::flixel::_system::debug::StatsGraph memoryGraph;
		::flixel::_system::debug::StatsGraph drawTimeGraph;
		::flixel::_system::debug::StatsGraph updateTimeGraph;
