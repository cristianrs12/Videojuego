...
#endif
HX_DECLARE_CLASS4(flixel,_system,debug,_Stats,GraphicMinimizeButton)
...
class HXCPP_CLASS_ATTRIBUTES  GraphicMinimizeButton_obj : public ::openfl::_legacy::display::BitmapData_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.system.debug._Stats.GraphicMinimizeButton")
