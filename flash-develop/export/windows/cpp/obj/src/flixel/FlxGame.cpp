...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(302)
		::String tmp26 = ::openfl::events::FocusEvent_obj::FOCUS_OUT;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(302)
		Dynamic tmp27 = this->onFocusLost_dyn();		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(302)
		...
		HX_STACK_LINE(303)
		::String tmp29 = ::openfl::events::FocusEvent_obj::FOCUS_IN;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(303)
		Dynamic tmp30 = this->onFocus_dyn();		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(303)
		tmp28->addEventListener(tmp29,tmp30,null(),null(),null());
		HX_STACK_LINE(310)
		{
			HX_STACK_LINE(310)
			::flixel::_system::frontEnds::SignalFrontEnd tmp31 = ::flixel::FlxG_obj::signals;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(310)
			tmp31->__Field(HX_HCSTRING("gameReset","\x7d","\x38","\xe3","\x1b"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(310)
			this->_skipSplash = true;
			HX_STACK_LINE(310)
			bool tmp32 = this->_skipSplash;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(310)
			...
			if ((tmp33)){
				...
				HX_STACK_LINE(310)
				::hx::Class tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(310)
				tmp34 = (tmp36 != null());
			}
			else{
			...
			if ((tmp34)){
				HX_STACK_LINE(310)
				::hx::Class tmp35 = this->_initialState;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(310)
				::flixel::FlxState tmp36 = ::Type_obj::createInstance(tmp35,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(310)
				this->_requestedState = tmp36;
				HX_STACK_LINE(310)
				::hx::Class tmp37 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(310)
				...
				::hx::Class tmp35 = this->_initialState;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(310)
				::flixel::_system::FlxSplash_obj::nextState = tmp35;
				HX_STACK_LINE(310)
				::flixel::_system::FlxSplash tmp36 = ::flixel::_system::FlxSplash_obj::__new(null());		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(310)
				this->_requestedState = tmp36;
				HX_STACK_LINE(310)
				this->_skipSplash = true;
			...
			HX_STACK_LINE(310)
			::flixel::FlxState tmp35 = this->_requestedState;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(310)
			bool tmp36 = ::Std_obj::is(tmp35,hx::ClassOf< ::flixel::FlxSubState >());		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(310)
			if ((tmp36)){
				HX_STACK_LINE(310)
		...
		this->switchState();
		HX_STACK_LINE(313)
		::flixel::FlxGame tmp31 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(313)
		int tmp32 = tmp31->_stepMS;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(313)
		Float tmp33 = (Float((int)1000) / Float(tmp32));		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(313)
		int tmp34 = ::Std_obj::_int(tmp33);		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(313)
		int tmp35 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(313)
		bool tmp36 = (tmp34 < tmp35);		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(313)
		if ((tmp36)){
			HX_STACK_LINE(315)
			::flixel::_system::frontEnds::LogFrontEnd tmp37 = ::flixel::FlxG_obj::log;		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(315)
			::flixel::_system::debug::LogStyle tmp38 = ::flixel::_system::debug::LogStyle_obj::WARNING;		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(315)
			tmp37->__Field(HX_HCSTRING("advanced","\xa2","\x69","\x7b","\x3b"), hx::paccDynamic )(HX_HCSTRING("FlxG.updateFramerate: The update framerate shouldn't be smaller than the draw framerate, since it can slow down your game.","\x81","\x2e","\x69","\x6b"),tmp38,true);
		}
		HX_STACK_LINE(319)
		::openfl::_legacy::display::Stage tmp37 = this->get_stage();		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(319)
		::String tmp38 = ::openfl::_legacy::events::Event_obj::ENTER_FRAME;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(319)
		Dynamic tmp39 = this->onEnterFrame_dyn();		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(319)
		tmp37->addEventListener(tmp38,tmp39,null(),null(),null());
		HX_STACK_LINE(323)
		::openfl::_legacy::display::Stage tmp40 = this->get_stage();		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(323)
		::String tmp41 = ::openfl::_legacy::events::Event_obj::RESIZE;		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(323)
		Dynamic tmp42 = this->onResize_dyn();		HX_STACK_VAR(tmp42,"tmp42");
		HX_STACK_LINE(323)
		tmp40->addEventListener(tmp41,tmp42,null(),null(),null());
		HX_STACK_LINE(326)
		::openfl::_legacy::display::MovieClip tmp43 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::Stage tmp44 = tmp43->get_stage();		HX_STACK_VAR(tmp44,"tmp44");
		HX_STACK_LINE(326)
		int tmp45 = tmp44->get_stageWidth();		HX_STACK_VAR(tmp45,"tmp45");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::MovieClip tmp46 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(326)
		::openfl::_legacy::display::Stage tmp47 = tmp46->get_stage();		HX_STACK_VAR(tmp47,"tmp47");
		HX_STACK_LINE(326)
		int tmp48 = tmp47->get_stageHeight();		HX_STACK_VAR(tmp48,"tmp48");
		HX_STACK_LINE(326)
		this->resizeGame(tmp45,tmp48);
	}
return null();
}
