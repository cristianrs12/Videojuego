...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(29)
	super::__construct(HX_HCSTRING("log","\x84","\x54","\x52","\x00"),tmp,null(),null(),null(),null(),null());
	HX_STACK_LINE(31)
...
bool Log_obj::add( cpp::ArrayBase Data,::flixel::_system::debug::LogStyle Style,hx::Null< bool >  __o_FireOnce){
...
void Log_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.Log","\xdc","\x28","\x35","\xf4");
