...
{
HX_STACK_FRAME("flixel.system.debug._Stats.GraphicMinimizeButton","new",0xfc967524,"flixel.system.debug._Stats.GraphicMinimizeButton.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::_Stats::GraphicMinimizeButton_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
void GraphicMinimizeButton_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug._Stats.GraphicMinimizeButton","\x32","\x53","\xac","\x8b");
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug__Stats_GraphicMinimizeButton","\x98","\xd1","\xda","\x26");
}
