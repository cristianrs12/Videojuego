...
{
HX_STACK_FRAME("flixel.system.debug._Stats.GraphicMaximizeButton","new",0xacd98052,"flixel.system.debug._Stats.GraphicMaximizeButton.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::_Stats::GraphicMaximizeButton_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
void GraphicMaximizeButton_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug._Stats.GraphicMaximizeButton","\x60","\xaf","\x22","\xef");
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug__Stats_GraphicMaximizeButton","\xc6","\x2d","\x51","\x8a");
}
