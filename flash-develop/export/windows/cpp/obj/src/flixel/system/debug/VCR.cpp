...
HX_STACK_ARG(Debugger,"Debugger")
{
	...
	HX_STACK_LINE(59)
	::flixel::_system::ui::FlxSystemButton tmp2 = Debugger->__Field(HX_HCSTRING("addButton","\xf3","\x96","\x04","\x92"), hx::paccDynamic )(::flixel::_system::debug::ButtonAlignment_obj::MIDDLE,tmp,tmp1,null(),null());		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(59)
	...
	HX_STACK_LINE(64)
	::flixel::_system::ui::FlxSystemButton tmp6 = Debugger->__Field(HX_HCSTRING("addButton","\xf3","\x96","\x04","\x92"), hx::paccDynamic )(::flixel::_system::debug::ButtonAlignment_obj::MIDDLE,tmp3,tmp5,null(),null());		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(64)
	...
	HX_STACK_LINE(65)
	::flixel::_system::ui::FlxSystemButton tmp9 = Debugger->__Field(HX_HCSTRING("addButton","\xf3","\x96","\x04","\x92"), hx::paccDynamic )(::flixel::_system::debug::ButtonAlignment_obj::MIDDLE,tmp7,tmp8,null(),null());		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(65)
	this->stepBtn = tmp9;
}
;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(VCR_obj,runtime),HX_HCSTRING("runtime","\xd8","\xb4","\x60","\xef")},
